...
public class JavaDungeons implements ModInitializer {
	...
	public static final ItemGroup DINGY_JUNGLE = FabricItemGroupBuilder.build(new Identifier(MOD_ID, "dingy_jungle"), () -> new ItemStack(DingyJungleBlocks.DJ_FLOWERING_JUNGLE_PLANT));
