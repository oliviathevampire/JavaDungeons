...
public class EnchanterEntity extends SpellcastingIllagerEntity {
	...
	public class SpellGoal extends SpellcastingIllagerEntity.CastSpellGoal {
		private final Predicate<LivingEntity> fillter = (entity) -> {
			return ! (entity instanceof EnchanterEntity) &&
					entity instanceof Monster/* && entity.getCapability(EnchantWithMob.MOB_ENCHANT_CAP).map(mob -> !mob.hasEnchant()).orElse(false)*/;
		};
		...
		public boolean shouldContinue() {
			return EnchanterEntity.this.getEnchantTarget() != null &&
					EnchanterEntity.this.getEnchantTarget() != EnchanterEntity.this.getTarget() &&
