...
public class DungeonsChains extends Block {
	...
	public BlockState getStateForNeighborUpdate(BlockState state, Direction facing, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
		...
		if (world.getBlockState(pos.up()).getBlock() instanceof DungeonsChains &&
				world.getBlockState(pos.down()).getBlock() instanceof DungeonsChains) {
			...
			boolean blockAbove =
					! world.isAir(pos.up()) && ! (world.getBlockState(pos.up()).getBlock() instanceof DungeonsChains);
			boolean blockBelow = ! world.isAir(pos.down()) &&
					! (world.getBlockState(pos.down()).getBlock() instanceof DungeonsChains);
