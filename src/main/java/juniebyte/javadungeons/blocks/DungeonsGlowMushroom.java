...
public class DungeonsGlowMushroom extends SeaPickleBlock {
	...
	public DungeonsGlowMushroom(Material material, float hardness, float resistance, BlockSoundGroup sounds) {
			...
			if (soundsPlayed <= 5) {
				...
				if (! velocity.equals(new Vec3d(0.0, - 0.0, 0.0))) {
					...
					world.playSound(
							...
							rand.nextFloat() *
									0.13f, //Random volume multiplier (multiplied by 0.13 to avoid ear explosion)
